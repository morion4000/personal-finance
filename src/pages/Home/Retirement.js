...
class Retirement extends Component {
  ...
  setRetirementYears() {
      let year = 1;
      let yearly_contribution = (this.state.monthly_revenue - this.state.expenses_sum) * 12;
    ...
    return (
      <React.Fragment>
        ...
        <center>
          ...
          <br />
          <center><h2>You can retire in <strong>{this.state.retirement_years + new Date().getFullYear()}</strong> <small>({this.state.retirement_years} years)</small></h2></center>
          <br />
          {this.state.chart_data.length && <Chart data={this.state.chart_data} refresh={this.state.refresh} />}
      </React.Fragment>
    );
  }
    ...
    return (
      <React.Fragment>
        <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
          ...
          <p className="lead">How far into the future can you retire based on your current assets, passive income, and expenses.</p>
        </div>
        ...
        <div className="container">
          <div className="card-deck mb-3 text-center">
            <div className="card mb-4 shadow-sm">
              ...
              <div className="card-body">
                <h1 className="card-title">
                  <NumberFormat value={this.state.estimated_worth} displayType={'text'} thousandSeparator={true} prefix={'$'} decimalScale={2} />
                </h1>
              </div>
            </div>
            <div className="card mb-4 shadow-sm">
              ...
              <div className="card-body">
                <h1 className="card-title">
                  <NumberFormat value={this.state.monthly_passive_revenue} displayType={'text'} thousandSeparator={true} prefix={'$'} decimalScale={0} />
            ...
            <div className="card mb-4 shadow-sm">
              ...
              <div className="card-body">
                <h1 className="card-title">
                  <NumberFormat value={this.state.expenses_sum} displayType={'text'} thousandSeparator={true} prefix={'$'} decimalScale={0} />
                  <small className="text-muted">/ mo</small>
                </h1>
              </div>
            </div>
          ...
          {this.state.monthly_revenue > this.state.expenses_sum && this.renderChart()}
          {this.state.monthly_revenue <= this.state.expenses_sum && <center><h4>Income is lower than expenses. Please add income or remove expenses.</h4></center>}
        </div>
      </React.Fragment>
    );
  }
